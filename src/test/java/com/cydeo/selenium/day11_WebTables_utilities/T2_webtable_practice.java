package com.cydeo.selenium.day11_WebTables_utilities;
...
//        Expected: 12/31/2021
        ...
        String expectedBobMartingDateCell = "12/31/2021";

        Assert.assertEquals(actualBobMartinDateCell,expectedBobMartingDateCell);
