package com.cydeo.selenium.day9_iframes;
...
//1- Open a chrome browser
    //This part You don't have to write because it is already in TestBase Folder.
...
//          2- Go to: https://practice.cydeo.com/iframe
        ...
        // NOSuchElement exception comes with reasons: 1- Not locating correctly element
        //                                              2- There is an iframe you have switch to frame to reach this element
...
//If you have nested frame and if you want to switch to direct parent of this frame we are using parentframe()
